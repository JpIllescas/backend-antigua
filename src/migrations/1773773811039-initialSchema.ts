...
export class InitialSchema1773773811039 implements MigrationInterface {
    name = 'InitialSchema1773773811039'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "gps_logs" ("id" BIGSERIAL NOT NULL, "deviceId" character varying(50) NOT NULL, "latitude" numeric(9,6) NOT NULL, "longitude" numeric(9,6) NOT NULL, "speed" numeric(6,2) NOT NULL DEFAULT '0', "is_buffered" boolean NOT NULL DEFAULT false, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "received_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_bf5a0a9cc743b0fb9b4a5bd70b8" PRIMARY KEY ("id"))`);
