...
export class InitialSchema1774289226478 implements MigrationInterface {
    name = 'InitialSchema1774289226478'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "gps_logs" ("id" BIGSERIAL NOT NULL, "deviceId" character varying(50) NOT NULL, "latitude" numeric(9,6) NOT NULL, "longitude" numeric(9,6) NOT NULL, "speed" numeric(6,2) NOT NULL DEFAULT '0', "is_buffered" boolean NOT NULL DEFAULT false, "satellite_ts" character varying(30), "signal_strength" integer, "operator" character varying(20), "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "received_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_bf5a0a9cc743b0fb9b4a5bd70b8" PRIMARY KEY ("id"))`);
